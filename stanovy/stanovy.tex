...
\section{Představenstvo} %4
	...
	\item Člen představenstva ztrácí mandát:
		...
		\end{enumerate}
	\item Řádné volby do představenstva vyhlašuje volební komise, kterou jmenuje předseda. Volby musí proběhnout do 30 dnů od tohoto usnesení. Po uplynutí jedenácti měsíců od posledních řádných voleb může volby vyhlásit předseda bez souhlasu představenstva. Průběh voleb upravuje interní předpis.
