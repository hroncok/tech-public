...
\section{Představenstvo} %4
	...
	\item Předseda musí do 30-ti dnů vyhlásit doplňovací volby do Představenstva pokud představenstvo nesplňuje podmínku definovanou v bodě \ref{predstavenstvo_slozeni}.
	...
	\item Člen představenstva ztrácí mandát:
		...
		\end{enumerate}
	\item Řádné volby do představenstva vyhlašuje předseda na základě usnesení představenstva. Volby musí proběhnout do 30 dnů od tohoto usnesení. Po uplynutí jedenácti měsíců od posledních řádných voleb může volby vyhlásit předseda bez souhlasu představenstva. Průběh voleb upravuje interní předpis.
